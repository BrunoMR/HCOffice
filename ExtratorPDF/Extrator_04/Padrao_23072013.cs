...
namespace Extrator
{
    ...
    public class Padrao_23072013
    {
        ...
        /// <summary>
        /// Método que verifica se o texto de entrada contém nome de imagem em formato válido
        /// </summary>
        /// <param name="entrada">Texto a ser analisado</param>
        /// <returns></returns>
        public static bool ContemNomeImagem(string entrada)
        {
            _match = _rgxNomeImagem.Match(entrada);
