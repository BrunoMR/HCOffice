...
BEGIN
  ...
  (
    ...
    DATA_VIGENCIA,
    MARCA_SEM_VOGAIS,
    NUMERO_INSCRICAO_INTERNACIONAL,
    DATA_RECEBIMENTO_INPI
  )
  SELECT
    PRO.NUMERO,
    PRO.NOME_TITULAR,
	...
	TPN.DESCRICAO AS TIPO_NATUREZA_DESCRICAO,
    ...
    PRO.NUMERO_INSCRICAO_INTERNACIONAL,
    PRO.DATA_RECEBIMENTO_INPI
  FROM
    ...
    JOIN TIPO_NATUREZA							TPN ON TPN.ID = PRO.TIPO_NATUREZA
  GROUP BY
    PRO.NUMERO,
    PRO.NOME_TITULAR,
    PRO.CPF_CNPJ_INPI_TITULAR,
