...
namespace Extrator
{
    public class DocumentoPDF
    {
        ...
        public void Carregar(
            string pathPDF, int paginaInicial, string pathRepositorio, 
            string[] processosIgnorados, string[] imagensIgnoradas)
        {
        ...
        public void ExtrairProcessos()
        {
            ...
            for (int pageNumber = this.PaginaPrimeiroProcesso; pageNumber <= this.PdfReader.NumberOfPages; pageNumber++)
            {
                ...
                for (int i = 0; i <= split.GetUpperBound(0); i++)
                {
                    ...
                    {
                        if (this.ProcessosIgnorados != null &&
                            this.ProcessosIgnorados.Contains(TextoRetorno))
                        {
                            processo = null;
                            continue;
                        }
