...
namespace ExtratorDeDados.Util
{
    public static class RegularExpressions
    {
        ...
        public static Regex TitularComEstadoLineRegex = new Regex(@"^Tit\.([^\(]+)\((\w+)\/(\w+)\)",
            RegexOptions.Compiled);

        public static Regex TitularSemEstadoLineRegex = new Regex(@"^Tit\.([^\(]+)\((\w+)\)", RegexOptions.Compiled);
        public static Regex Titular3LineRegex = new Regex(@"^Tit\.([^\n]+)", RegexOptions.Compiled);
        ...
        //public static Regex FifthLineRegex = new Regex(@"Marca: (.+)NCL\(", RegexOptions.Compiled);
